            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2" style="padding:15px;">
                        ...
                        <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;"><span style="display:block;font-size:13px;font-weight:normal;">Jumlah Pengunjung</span> {{ $detail['inquiry_jumlah_pengunjung'] }} <b style="font-size:12px;font-weight:300;"></b></p>
                        ...
                        <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;"><span style="display:block;font-size:13px;font-weight:normal;">Jumlah Pasien</span> {{ $detail['inquiry_jumlah_pasien'] }} <b style="font-size:12px;font-weight:300;"></b></p>
                        <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;"><span style="display:block;font-size:13px;font-weight:normal;">Jenis Bahan Baku</span> {{ $detail['inquiry_jenis_bahan_baku'] }} <b style="font-size:12px;font-weight:300;"></b></p>
                        <p style="font-size:14px;margin:0;padding:10px;border:solid 1px #ddd;font-weight:bold;"><span style="display:block;font-size:13px;font-weight:normal;">Jenis Bahan Penolong/Tambahan</span> {{ $detail['inquiry_jenis_bahan_penolong_tambahan'] }} <b style="font-size:12px;font-weight:300;"></b></p>
