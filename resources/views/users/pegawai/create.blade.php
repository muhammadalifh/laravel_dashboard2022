...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Buat Pegawai') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('users.pegawai.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="no_telp" type="number" class="form-control" name="no_telp" required autocomplete="no_telp">
