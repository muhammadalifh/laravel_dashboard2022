                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="text-center">Benchmark Submit</h2>
                        </div>
                        <div class="card-body">
                            <p class="lead text-center">A place to submit your VPS benchmark to be indexed and formatted
                                into
                                json data for
                                easier viewing and sharing.</p>
                            <form id="submit-form" method="post" action="insert.php" role="form">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="form_provider">Provider:</label>
                                            <input id="form_provider" type="text" name="provider" class="form-control"
                                                placeholder="Hosting provider" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input id="form_price" type="number" name="price" class="form-control"
                                                placeholder="5.00" min="0" step="any" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="term" name="term">
                                                ...
                                                <option value="4">Semi (half year)</option>
                                                <option value="5">Annually (yearly)</option>
                                                <option value="6">Biennial (2 years)</option>
                                                <option value="7">Triennial (3 years)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="form_term">Currency:</label>
                                            <select class="form-control" id="form_term" name="term">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="bench_type">Benchmark type:</label>
                                            <select class="form-control" id="bench_type" name="bench_type">
                                                <option value="1" selected>bench.sh</option>
                                                <option value="2">YABS</option>
                                                <option value="3">nench</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="output">Benchmark output:</label>
